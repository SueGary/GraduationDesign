...
namespace PEIS_SPZZ.UIL
{
    public partial class GraphForm : Form
    {
        ...
        private void GraphForm_Load(object sender, EventArgs e)
        {
            ...
            if (myCurve == null)
            {
                myCurve = this.zedGraphControl1.GraphPane.AddCurve("收缩压", list1, Color.Blue, SymbolType.Circle);
                myCurve = this.zedGraphControl1.GraphPane.AddCurve("舒张压", list2, Color.Red, SymbolType.Circle);
            }
            //刷新、重绘折线图
