...
{
    /// <summary>
    /// 对象名称：“空白模块模块”添加界面控件（用户界面层）
    /// 对象说明：该界面用于添加“个人信息”对象至数据库，添加操作成功后返回列表界面。
    /// 作者姓名：苏嘉立
    ...
    public partial class Create : UserControl
    {
        ...
        public static Create Instance
        {
            get
            {
                ...
                instance.gRXX = new GRXX(); // 创建新的关联对象，可以在“数据实体层”中指定对象的默认值。
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            GRXXBLL.Insert(gRXX); // 调用“业务逻辑层”的方法，检查有效性后插入至数据库。
            FormSysMessage.ShowSuccessMsg("“个人信息”添加成功，单击“确定”按钮返回信息列表。");
