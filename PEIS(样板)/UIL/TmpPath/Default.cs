...
{
    /// <summary>
    /// 对象名称：“空白模块模块”列表界面控件（用户界面层）
    /// 对象说明：该界面显示所有“个人信息”的信息列表，可以通过该界面导航到相应的添加、修改、删除界面。
    /// 作者姓名：苏嘉立
    ...
    public partial class Default : UserControl
    {
        ...
        public static void BindDataGrid()
        {
            ...
            instance.PageBar.DataSource = GRXXBLL.GetPageList(instance.PageBar.PageSize, instance.PageBar.CurPage);
